...
var ApprovedQuotationPage = (function () {
    ...
    ApprovedQuotationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-approved-quotation',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\approvedQuotations.html"*/`<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>Approved </ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n\n\n    <ion-list>\n\n        <ion-item *ngFor="let quotation of quotations;let i of index" class="bottom-border emp" (click)="viewQuotation(quotation)">\n\n            <p text-left>{{quotation.title}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\approvedQuotations.html"*/
        }),
...
var ArchivedQuotationPage = (function () {
    ...
    ArchivedQuotationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-archived-quotation',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\archivedQuotations.html"*/`<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>Archived</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item *ngFor="let quotation of quotations;let i of index" class="bottom-border emp" (click)="viewQuotation(quotation)">\n\n            <p text-left>{{quotation.title}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\archivedQuotations.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["PopoverController"], __WEBPACK_IMPORTED_MODULE_2__service_authService__["a" /* authService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"]])
...
var DraftedQuotationPage = (function () {
    ...
    DraftedQuotationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-drafted-quotation',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\draftedQuotations.html"*/`<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>Drafts </ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item *ngFor="let quotation of quotations;let i of index" class="bottom-border emp" (click)="viewQuotation(quotation)">\n\n            <p text-left>{{quotation.title}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\draftedQuotations.html"*/
        }),
...
var SubmittedQuotationPage = (function () {
    ...
    SubmittedQuotationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-submitted-quotation',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\submittedQuotations.html"*/`<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n        <ion-title>Sent </ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-list>\n\n        <ion-item *ngFor="let quotation of quotations;let i of index" class="bottom-border emp" (click)="viewQuotation(quotation)">\n\n            <p text-left>{{quotation.title}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\submittedQuotations.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["PopoverController"], __WEBPACK_IMPORTED_MODULE_2__service_authService__["a" /* authService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"]])
...
var AttendancePage = (function () {
    function AttendancePage(navCtrl, myService, attendanceService, popoverCtrl, component, events) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.myService = myService;
        this.attendanceService = attendanceService;
        ...
        // this.searchAttendances(searchCriteria);
    ...
    AttendancePage.prototype.getAllAttendance = function () {
        var _this = this;
    ...
    AttendancePage.prototype.searchAttendances = function (searchCriteria) {
        var _this = this;
        this.component.showLoader('');
        this.attendanceService.searchAttendances(searchCriteria).subscribe(function (response) {
            console.log("SEarch attendance response");
            console.log(response);
            _this.attendances = response;
            _this.component.closeLoader();
        }, function (err) {
...
var ViewJobPage = (function () {
    ...
    ViewJobPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-view-job',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\jobs\view-job.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Jobs</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n\n\n\n\n    <div class="card" >\n\n\n\n                    <div class="card-content padding-bottom0" >\n\n                        <div>\n\n                            {{jobDetails.description}}\n\n                            {{jobDetails.employeeId}}\n\n                            {{jobDetails.employeeName}}\n\n                        </div>\n\n\n\n                    </div>\n\n\n\n                    <div class="card-footer">\n\n\n\n                    </div>\n\n\n\n\n\n    </div>\n\n\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\jobs\view-job.html"*/
        }),
...
var JobPopoverPage = (function () {
    ...
    JobPopoverPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-job-popover',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\jobs\job-popover.html"*/`<ion-content>\n\n\n\n    <div>\n\n        <img [src]="img" class="job-img margin-bottom25">\n\n    </div>\n\n    <div class="align-center">\n\n        <button ion-button clear color="danger" (click)="deleteImg(index)" icon-only><ion-icon name="trash"></ion-icon></button>\n\n    </div>\n\n\n\n\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\jobs\job-popover.html"*/
        }),
...
var AttendancePopoverPage = (function () {
    ...
    AttendancePopoverPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-attendance-popover',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\attendance\attendance-popover.html"*/`<ion-content>\n\n\n\n    <div>\n\n        <img [src]="img">\n\n    </div>\n\n\n\n\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\attendance\attendance-popover.html"*/
        }),
...
var AttendanceViewPage = (function () {
    ...
    AttendanceViewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-attendance-view',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\attendance-view\attendance-view.html"*/`<!--\n\n  Generated template for the AttendanceViewPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>attendance-view</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div class="align-center">\n\n    <img *ngIf="img" [src]="domSanitizer.bypassSecurityTrustUrl(img)" width="80%" height="70%" class="margin-auto">\n\n  </div>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\attendance-view\attendance-view.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_64__components_has_permission_has_permission__ = __webpack_require__(862);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_64__components_has_permission_has_permission__["a" /* HasPermission */]
            ],
            imports: [
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\app\app.html"*/`<ion-menu class="menu-width" [content]="content">\n\n\n\n\n\n  <ion-content>\n\n\n\n    <div class="wrapper">\n\n      <div class="sidebar" data-color="rose" data-background-color="black"  data-image="img/sidebar-1.jpg">\n\n      <!--\n\n    Tip 1: You can change the color of the sidebar using: data-color="purple | blue | green | orange | red"\n\n\n\n    Tip 2: you can also add an image using data-image tag\n\n  -->\n\n        <div class="logo">\n\n          <p text-center>{{userName}}</p>\n\n        </div>\n\n        <div class="sidebar-wrapper">\n\n          <ul class="nav">\n\n            <li menuClose *ngFor="let p of pages" (click)="openPage(p)" [ngClass]="{\'active\':p.active}"  >\n\n              <a>\n\n                <i class="material-icons">{{p.icon}}</i>\n\n                <p>{{p.title}}</p>\n\n              </a>\n\n            </li>\n\n            <li menuClose (click)="logout()">\n\n              <a>\n\n                  <i class="material-icons">exit_to_app</i>\n\n                  <p>Logout</p>\n\n              </a>\n\n            </li>\n\n          </ul>\n\n        </div>\n\n      </div>\n\n    </div>\n\n    <!--\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n    </ion-list>-->\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\app\app.html"*/
        }),
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\home\home.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h3>Ionic Menu Starter</h3>\n\n\n\n  <p>\n\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n\n  </p>\n\n\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\home\home.html"*/
        }),
...
var ListPage = (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-list',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\list\list.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n\n      {{item.title}}\n\n      <div class="item-note" item-end>\n\n        {{item.note}}\n\n      </div>\n\n    </button>\n\n  </ion-list>\n\n  <div *ngIf="selectedItem" padding>\n\n    You navigated here from <b>{{selectedItem.title}}</b>\n\n  </div>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\list\list.html"*/
        }),
...
var ReportsPage = (function () {
    ...
    ReportsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-reports',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\reports\reports.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h3>Ionic Menu Starter</h3>\n\n\n\n  <p>\n\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n\n  </p>\n\n\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\reports\reports.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]])
    ], ReportsPage);
    return ReportsPage;
...
var LogoutPage = (function () {
    ...
    LogoutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-logout',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\logout\logout.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <h3>Ionic Menu Starter</h3>\n\n\n\n  <p>\n\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n\n  </p>\n\n\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\logout\logout.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"]])
    ], LogoutPage);
    return LogoutPage;
...
var QuotationViewPage = (function () {
    ...
    QuotationViewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-view-quotation',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\quotation-view.html"*/`<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Quotation</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n          <div class="row padding0 margin0 white-bg">\n\n            <ion-col col-12 class="padding-top0">\n\n              <div class="table-responsive table-sales">\n\n                <table class="table">\n\n                  <tbody>\n\n                  <tr (click)="quotationView()">\n\n                    <td>\n\n                      <div class="flag">\n\n                        <img src="../assets/img/flags/US.png">\n\n                      </div>\n\n                    </td>\n\n                    <td>Approved</td>\n\n                    <td class="text-right">\n\n                      <span class="clr-orange padding-right2">(</span>0<span class="clr-orange padding-left2">)</span>\n\n                    </td>\n\n                    <td class="text-right">\n\n                      <ion-icon class="primary-clr padding-left5 fnt-12" name="arrow-forward"></ion-icon>\n\n                    </td>\n\n                  </tr>\n\n                  <tr>\n\n                    <td>\n\n                      <div class="flag">\n\n                        <img src="../assets/img/flags/DE.png">\n\n                      </div>\n\n                    </td>\n\n                    <td>Overdue</td>\n\n                    <td class="text-right">\n\n                      <span class="clr-orange padding-right2">(</span>0<span class="clr-orange padding-left2">)</span>\n\n                    </td>\n\n                    <td class="text-right">\n\n                      <ion-icon class="primary-clr padding-left5 fnt-12" name="arrow-forward"></ion-icon>\n\n                    </td>\n\n                  </tr>\n\n                  <tr>\n\n                    <td>\n\n                      <div class="flag">\n\n                        <img src="../assets/img/flags/AU.png">\n\n                      </div>\n\n                    </td>\n\n                    <td>Requested</td>\n\n                    <td class="text-right">\n\n                      <span class="clr-orange padding-right2">(</span>0<span class="clr-orange padding-left2">)</span>\n\n                    </td>\n\n                    <td class="text-right">\n\n                      <ion-icon class="primary-clr padding-left5 fnt-12" name="arrow-forward"></ion-icon>\n\n                    </td>\n\n                  </tr>\n\n                  <tr>\n\n                    <td>\n\n                      <div class="flag">\n\n                        <img src="../assets/img/flags/AU.png">\n\n                      </div>\n\n                    </td>\n\n                    <td>Archieved</td>\n\n                    <td class="text-right">\n\n                      <span class="clr-orange padding-right2">(</span>0<span class="clr-orange padding-left2">)</span>\n\n                    </td>\n\n                    <td class="text-right">\n\n                      <ion-icon class="primary-clr padding-left5 fnt-12" name="arrow-forward"></ion-icon>\n\n                    </td>\n\n                  </tr>\n\n                  </tbody>\n\n                </table>\n\n              </div>\n\n            </ion-col>\n\n          </div>\n\n</ion-content>\n\n`/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\quotation-view.html"*/
        }),
...
var CreateQuotationPage3 = (function () {
    ...
    CreateQuotationPage3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-create-quotation-step3',template:/*ion-inline-start:"D:\workspace\FMS\MobileApp\src\pages\quotation\create-quotation-step-3.html"*/``/*ion-inline-end:"D:\workspace\FMS\MobileApp\src\pages\quotation\create-quotation-step-3.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["PopoverController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["Events"], __WEBPACK_IMPORTED_MODULE_2__service_authService__["a" /* authService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"]])
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HasPermission; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var HasPermission = (function () {
    function HasPermission(el, renderer) {
        console.log('Hello HasPermission Directive');
    }
    HasPermission = __decorate([
