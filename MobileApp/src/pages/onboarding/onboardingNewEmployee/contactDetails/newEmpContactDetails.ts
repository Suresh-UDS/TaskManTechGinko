      ...
      if (status == 'VALID') {
        ...
        this.storage.get('OnBoardingData').then(localStoragedData => {
          if(localStoragedData && localStoragedData['actionRequired'] && localStoragedData['actionRequired'][this.storedIndex] && localStoragedData['actionRequired'][this.storedIndex]['contactDetails']){
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['checkSameAsPresent'] = this.formStatusValues['data']['checkSameAsPresent'] ;
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['contactNumber'] = this.formStatusValues['data']['contactNumber'];
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['emergencyConatctNo'] = this.formStatusValues['data']['emergencyConatctNo'];
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['communicationAddress'][0]['address'] = this.formStatusValues['data']['communicationAddress'][0]['address'];
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['communicationAddress'][0]['city'] = this.formStatusValues['data']['communicationAddress'][0]['city'] ;
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['communicationAddress'][0]['state'] = this.formStatusValues['data']['communicationAddress'][0]['state'];
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['permanentAddress'][0]['address'] = this.formStatusValues['data']['permanentAddress'][0]['address'] ;
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['permanentAddress'][0]['city'] = this.formStatusValues['data']['permanentAddress'][0]['city'] ;
            localStoragedData['actionRequired'][this.storedIndex]['contactDetails']['permanentAddress'][0]['state'] = this.formStatusValues['data']['permanentAddress'][0]['state'];
