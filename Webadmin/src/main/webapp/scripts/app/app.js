...
angular.module('timeSheetApp', ['LocalStorageModule',
    ...
    'ngResource', 'ui.router', 'ngCookies', 'ngAria', 'ngCacheBuster', 'ngFileUpload', 'infinite-scroll', 'App.filters','uiGmapgoogle-maps','checklist-model','alexjoffroy.angular-loaders','chart.js','star-rating','jkAngularRatingStars'])
