demo = {
    ...
    showApproveAlert: function(employee){
        swal({
            title: 'Are you sure?',
            text: 'Approve Image for the employee - '+employee.fullName,
            type: 'warning',
            showCancelButton: true,
            ...
            swal({
                title: 'Approved!',
                text: 'Employee '+employee.fullName+' has been approved for Face Attendance.',
                type: 'success',
                confirmButtonClass: "btn btn-success",
                buttonsStyling: false
            }).catch(swal.noop)
            ...
            if (dismiss === 'cancel') {
                swal({
                    title: 'Denied',
                    text: 'Approval for the employee '+employee.fullName+' has been denied.',
                    type: 'error',
                    confirmButtonClass: "btn btn-info",
                    buttonsStyling: false
                }).catch(swal.noop)
