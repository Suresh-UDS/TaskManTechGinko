...
public class UserService extends AbstractService {
    ...
    public List<User> findUsers(long siteId) {
    	...
    	/*
    	List<Employee> employees = siteRepository.findEmployees(siteId);
    	List<Long> empIds = new ArrayList<Long>();
    	for(Employee emp : employees) {
    		empIds.add(emp.getId());
    	}
    	users = employeeRepository.findUsersByEmployeeIds(empIds);
    	*/
    ...
    public void updateUserInformation(String firstName, String lastName, String email, String langKey, long employeeId, boolean emailSubscribed) {
	...
	private void buildSearchResult(SearchCriteria searchCriteria, Page<User> page, List<UserDTO> transactions, SearchResult<UserDTO> result) {
		if(page != null) {
