...
public class EmpSpecification implements Specification<Employee> {
    ...
    private final Logger log = LoggerFactory.getLogger(EmpSpecification.class);
     ...
     */
    public EmpSpecification(SearchCriteria searchCriteria, boolean isAdmin) {
    ...
    public Predicate toPredicate(Root<Employee> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
        ...
        if(searchCriteria.isOnBoarded()) {
        	 if(StringUtils.isNotEmpty(searchCriteria.getOnBoardedFrom())){
             	predicates.add(builder.equal(root.get("onBoardedFrom"), searchCriteria.getOnBoardedFrom()));
             }else {
            	 predicates.add(builder.isNotNull(root.get("onBoardedFrom")));
             }
        }else{
        	predicates.add(builder.isNull(root.get("onBoardedFrom")));
        }
