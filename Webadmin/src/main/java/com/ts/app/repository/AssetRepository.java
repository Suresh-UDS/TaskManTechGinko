...
public interface AssetRepository extends JpaRepository<Asset, Long>,JpaSpecificationExecutor<Asset> {
    ...
    @Query("SELECT count(a) FROM Asset a WHERE a.site.id = :siteId and a.active='Y' and a.status = :status")
    long getAssetCountByStatus(@Param("siteId") long siteId, @Param("status") String status);

    @Query("SELECT count(a) FROM Asset a WHERE a.site.id = :siteId and a.active='Y'")
    long getAssetCount(@Param("siteId") long siteId);
