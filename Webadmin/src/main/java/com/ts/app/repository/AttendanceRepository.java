...
public interface AttendanceRepository extends JpaRepository<Attendance, Long>,JpaSpecificationExecutor<Attendance> {
    ...
    */
    ...
    @Query("SELECT a from Attendance a where a.checkInTime between :startDate and :endDate and a.checkOutTime is null order by a.checkInTime desc")
    List<Attendance> findByCheckInDateAndNotCheckout(@Param("startDate") Date startDate, @Param("endDate") Date endDate);
