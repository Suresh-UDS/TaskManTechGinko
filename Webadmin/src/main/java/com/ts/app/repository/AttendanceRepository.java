...
public interface AttendanceRepository extends JpaRepository<Attendance, Long>,JpaSpecificationExecutor<Attendance> {
    ...
    */
    ...
    @Query("SELECT new com.ts.app.domain.EmployeeAttendanceReport(e.id,e.empId, e.name, e.lastName, a.site.name, a.site.project.name, a.checkInTime, a.checkOutTime, a.shiftStartTime, a.shiftEndTime, a.continuedAttendance.id, a.late) from Attendance a join a.employee e where a.employee.id = e.id and a.site.id = :siteId and a.checkInTime between :startDate and :endDate order by a.checkInTime desc")
