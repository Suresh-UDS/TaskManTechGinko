...
public interface AttendanceRepository extends JpaRepository<Attendance, Long>,JpaSpecificationExecutor<Attendance> {
    ...
    @Query("SELECT a from Attendance a where a.employee.id = :empId and a.checkInTime between :startDate and :endDate and a.checkOutTime is null")
    Attendance findCurrentCheckIn(@Param("empId") long empId, @Param("startDate") Date startDate, @Param("endDate") Date endDate);
    ...
    */
    ...
    @Query("SELECT new com.ts.app.domain.EmployeeAttendanceReport(e.id,e.empId, e.name, e.lastName, a.site.name, a.site.project.name, a.checkInTime, a.checkOutTime, a.shiftStartTime, a.shiftEndTime, a.continuedAttendance.id, a.late,a.remarks) from Attendance a join a.employee e where a.employee.id = e.id and a.site.id = :siteId and a.checkInTime between :startDate and :endDate order by a.checkInTime desc")
